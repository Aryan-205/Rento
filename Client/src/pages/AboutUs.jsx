...
export default function AboutUs() {
  return (
    <>
      <Header/>
      <div className="flex flex-col items-center gap-8 p-8 mt-40">
        <h1 className="text-white text-5xl text-bold font-serif">Experience the Art of Driving - <span className="text-gray-400"> Redefined.</span></h1>
        <p className="text-white text-3xl w-[80%]">At <span className="text-transparent bg-clip-text bg-gradient-to-tr from-red-600 to-black font-bold">Rento</span>, we believe that driving should be more than just a means of transport—it should be an experience. As India's Premier Luxury car rental service, we bring the world's most coveted automotive marques to your fingertips. Whether it's the raw power of a Ferrari, the timeless elegance of a Rolls-Royce, or the fierce presence of a Lamborghini, we make Luxury accessible on your terms.</p>
      </div>
      <div className="p-8">
        <h1 className="text-white text-5xl my-8">Our Fleet</h1>
        <p className="text-gray-300 text-xl">Our meticulously curated fleet features brands that define performance, prestige, and perfection:</p>
        ...
        <p className="text-gray-300 text-xl">Each vehicle is maintained to the highest standard and delivered with unmatched attention to detail.</p>
      </div>
      <div className="p-8">
        <h1 className="text-gray-300 text-5xl my-8">Where We Operate</h1>
        <p className="text-gray-300 text-xl">With availability across India's key metros and emerging hubs, we are where you need us:</p>
        ...
        <p className="text-gray-300 text-xl">Whether it's a weekend escape, a wedding, a corporate appearance, or just the need to feel something extraordinary — we are at your service.</p>
      </div>
      <div className="p-8">
      ...
      <div className="p-8">
        <h1 className="text-gray-300 text-5xl my-8">Our Promise</h1>
        <p className="text-white text-2xl">Luxury isn't just about the car — it's about the entire experience. From the first click to the final kilometer, our team is dedicated to delivering a seamless, stylish, and unforgettable journey.</p>
      </div>
      <Footer/>
    </>
  )
