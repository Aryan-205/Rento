    ...
    <div className="relative">
      ...
      <div className="flex flex-col p-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 justify-between mt-4 md:mt-20 gap-8">
          <div className=" shadow-[0_0_8px_1px_white] rounded-lg h-40 md:h-72 p-8 flex flex-col justify-between">
            <div className="rounded-full bg-gray-500 p-2 w-10 md:w-16">
              <img src="/24-7icon.png" alt=""/>
            </div>
            <p className="text-white text-md md:text-xl font-bold w-52">24-hour car delivery</p>
          </div>
          <div className=" shadow-[0_0_8px_1px_white] rounded-lg h-40 md:h-72 p-8 flex flex-col justify-between">
            <div className="rounded-full bg-gray-500 w-10 md:w-16">
