...
export default function Footer() {
    ...
    return (
      <footer className="relative bg-black border-y">
          <div className="absolute -bottom-16 left-0 right-0">
              <h1 className="font-bold bg-gradient-to-t from-[#e14b4b] via-[#2c1818] to-neutral-900 bg-clip-text text-transparent text-[20rem] transition-all duration-500 ease-in-out text-center">
                  Rento
              </h1>
          </div> 
